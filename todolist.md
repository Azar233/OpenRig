...
- OpenRig 已采用 `GPL-3.0-only`，并固定 `audiosdk/asio` Commit `496a0765b8bb9c26f764f22f9a9712a937177db2`。ASIO Build 必须使用该 submodule，不得退回 iPlug2/RtAudio 内嵌但缺少当前许可文件的旧快照；Trademark/Logo 仍需独立检查。
